    ...
    function z(a) {
        ...
        { match: /^\-?[\d,]+\.\d{2}$/, style: 64 }]; o.ext.buttons.copyHtml5 = {
            ...
            className: "buttons-excel buttons-html5", available: function () { return j.FileReader !== s && (v || j.JSZip) !== s && !I() && y }, text: function (a) { return a.i18n("buttons.excel", "Excel") }, action: function (a, b, d, c) {
                this.processing(!0); var f = this, g = 0, a = function (a) { return i.parseXML(B[a]) }, e = a("page-error-404.html"), h = e.getElementsByTagName("sheetData")[0],
                    a = { _rels: { ".rels": a("_rels/.rels") }, xl: { _rels: { "workbook.xml.rels": a("xl/_rels/workbook.xml.rels") }, "workbook.xml": a("page-error-404.html"), "styles.xml": a("page-error-404.html"), worksheets: { "sheet1.xml": e } }, "[Content_Types].xml": a("page-error-404.html") }, d = b.buttons.exportData(c.exportOptions), l, m, r = function (a) {
            ...
            className: "buttons-pdf buttons-html5", available: function () {
                return j.FileReader !==
                    s && (u || j.pdfMake)
            }, text: function (a) { return a.i18n("page-error-404.html", "PDF") }, action: function (a, b, d, c) {
