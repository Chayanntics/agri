...
<div class="card">
    <div class="card-header">
        <div>
            <h4 class="card-title">customer business Form</h4>
    ...
    <div class="card-body">
        <div class="basic-form ps-3 pe-3 pb-3">
            ...
            <form method="post" action="functions/post.php" class="form-valide-with-icon needs-validation" novalidate id="frm-row" enctype="multipart/form-data">
                ...
                <input type='hidden' id='form-table' name='table[]' class='none' value='tbl_customer_business'>

                <div id="form-div-customer_business">
                    <div class="form-source">

                        <input type='hidden' id='customer_business-tbl_customer_business_id' name='tbl_customer_business-tbl_customer_business_id[]' class='editable none' value=''>
                        <div class='row'>

                                                                <div class='col-md-12 form-group '>
                                        <div class='row mb-2'>

                                            <label for='customer_business-tbl_customer_id' class="text-label form-label">customer:</label>

                                            <div class=''>
                                                <select name='tbl_customer_business-tbl_customer_id[]' id='customer_business-tbl_customer_id' class='form-control editable ' required>
...
?>
                                        ...
                                        <div class='row mb-2'>
                                            ...
                                            <label for='customer_business-tbl_business_id' class="text-label form-label">business:</label>

                                            <div class=''>
                                                <select name='tbl_customer_business-tbl_business_id[]' id='customer_business-tbl_business_id' class='form-control editable ' required>
                                                    <option value=''>-select-</option>
...
extract($r);
 ?>
                                                        ...
                                                        <option value='<?=  $tbl_business_id  ?>'><?=  $business_name  ?></option>
...
?>
                            ...
                            <div class="col-md-12 text-end">
                                <button type='button' class='btn btn-outline-info btn-sm' onclick="addNewForm('#form-div-customer_business')">Add New (+)</button>
                            </div>
                        </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card dz-card">
                        <div class="card-header flex-wrap">
                            <div>
                                <h4 class="card-title">customer business List</h4>
                                <!-- <p class="m-0 subtitle">Lorem Ipsum</p> -->
                            </div>
                        </div>
...
<?php
$sql = "SELECT * FROM tbl_customer_business  LEFT JOIN tbl_customer ON tbl_customer.tbl_customer_id=tbl_customer_business.tbl_customer_id LEFT JOIN tbl_business ON tbl_business.tbl_business_id=tbl_customer_business.tbl_business_id";
$m->sql = $sql;
$record = $m->selectRaw();
?>

<div class="table-responsive">
    <table id="datatable-customer_business" class="dt-table display table" style="width: calc(100% - 2px)">
        <thead>
            <tr class='text-center'>
                        ...
                        <label class='mb-0'>Customer</label>
                                    ...
                                    <td class='text-center'>
                        <label class='mb-0'>Business</label>
                    </td>
                                                    <td class=" text-center">
...
<span class="row-td" id="td-<?= $k ?>-tbl_customer_business-tbl_customer_business_id" hidden><?= $tbl_customer_business_id; ?></span>

<span class="row-td" id="td-<?= $k ?>-tbl_customer_business-tbl_customer_id" hidden><?= $tbl_customer_id; ?></span>

<span class="row-td" id="td-<?= $k ?>-tbl_customer_business-tbl_business_id" hidden><?= $tbl_business_id; ?></span>
                <tr>
                                                                                            <td class="text-center">
<?= $tbl_customer_business_id; ?></td>
                                                                                            <td class="text-center">
<?= $customer_name; ?></td>
                                                                                            <td class="text-center">
<?= $business_name; ?></td>
...
<button type="button" class="btn btn-outline-danger btn-action me-2" onclick="deleteInfo('tbl_customer_business','tbl_customer_business_id',<?=  $tbl_customer_business_id;  ?>)"><i class="bi bi-trash"></i></button>
</td>
                                    </tr>
