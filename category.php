                        ...
                        <div class="card-body">
                            <div class="basic-form ps-3 pe-3 pb-3">
                                ...
                                <form method="post" action="functions/post.php" class="form-valide-with-icon needs-validation" novalidate id="frm-row" enctype="multipart/form-data">
                                    ...
                                    <input type='hidden' id='form-table' name='table[]' class='none' value='tbl_category'>

                                    <div id="form-div-category">
                                        <div class="form-source">

                                            <input type='hidden' id='category-tbl_category_id' name='tbl_category-tbl_category_id[]' class='editable none' value=''>
                                            <div class='row'>

                                                <div class='col-md-12 form-group '>
                                                    <div class='row mb-2'>

                                                        <label for='category-category_name' class="text-label form-label">category name:</label>

                                                        <div class=''>
                                                            <input type='text' name='tbl_category-category_name[]' id='category-category_name' class='form-control editable ' value='' required>
                                                            <div class="invalid-feedback">
                                                                Please Enter a categpry name.
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="row multi-form" hidden>
                                        <div class="col-md-12 text-end">
                                            <button type='button' class='btn btn-outline-info btn-sm' onclick="addNewForm('#form-div-category')">Add New (+)</button>
                                        </div>
                                    </div>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade show active p-4">
                                ...
                                <div class="table-responsive">
                                    <table id="datatable-category" class="dt-table display table" style="width: calc(100% - 2px)">
                                        <thead>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                ...
                                                <span class="row-td" id="td-<?= $k ?>-tbl_category-tbl_category_id" hidden><?= $tbl_category_id; ?></span>

                                                <span class="row-td" id="td-<?= $k ?>-tbl_category-category_name" hidden><?= $category_name; ?></span>
                                                <tr>
                                                    <td class="text-center">
                                                        <?= $tbl_category_id; ?></td>
                                                    <td class="text-center">
                                                    ...
                                                    <td class="text-center ">
                                                        ...
                                                        <button type="button" class="btn btn-outline-danger btn-action me-2" onclick="deleteInfo('tbl_category','tbl_category_id',<?= $tbl_category_id;  ?>)"><i class="bi bi-trash"></i></button>
                                                    </td>
                                                </tr>
