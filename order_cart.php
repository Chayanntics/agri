...
<div class="card">
    <div class="card-header">
        <div>
            <h4 class="card-title">order cart Form</h4>
    ...
    <div class="card-body">
        <div class="basic-form ps-3 pe-3 pb-3">
            ...
            <form method="post" action="functions/post.php" class="form-valide-with-icon needs-validation" novalidate id="frm-row" enctype="multipart/form-data">
                ...
                <input type='hidden' id='form-table' name='table[]' class='none' value='tbl_order_cart'>

                <div id="form-div-order_cart">
                    <div class="form-source">

                        <input type='hidden' id='order_cart-tbl_order_cart_id' name='tbl_order_cart-tbl_order_cart_id[]' class='editable none' value=''>
                        <div class='row'>

                                                                <div class='col-md-12 form-group '>
                                        <div class='row mb-2'>

                                            <label for='order_cart-tbl_order_id' class="text-label form-label">order:</label>

                                            <div class=''>
                                                <select name='tbl_order_cart-tbl_order_id[]' id='order_cart-tbl_order_id' class='form-control editable ' required>
...
?>
                                        ...
                                        <div class='row mb-2'>
                                            ...
                                            <label for='order_cart-tbl_cart_id' class="text-label form-label">cart:</label>

                                            <div class=''>
                                                <select name='tbl_order_cart-tbl_cart_id[]' id='order_cart-tbl_cart_id' class='form-control editable ' required>
                                                    <option value=''>-select-</option>
...
extract($r);
 ?>
                                                        ...
                                                        <option value='<?=  $tbl_cart_id  ?>'><?=  $quantity_cart  ?></option>
...
?>
                            ...
                            <div class="col-md-12 text-end">
                                <button type='button' class='btn btn-outline-info btn-sm' onclick="addNewForm('#form-div-order_cart')">Add New (+)</button>
                            </div>
                        </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card dz-card">
                        <div class="card-header flex-wrap">
                            <div>
                                <h4 class="card-title">order cart List</h4>
                                <!-- <p class="m-0 subtitle">Lorem Ipsum</p> -->
                            </div>
                        </div>
...
<?php
$sql = "SELECT * FROM tbl_order_cart  LEFT JOIN tbl_order ON tbl_order.tbl_order_id=tbl_order_cart.tbl_order_id LEFT JOIN tbl_cart ON tbl_cart.tbl_cart_id=tbl_order_cart.tbl_cart_id";
$m->sql = $sql;
$record = $m->selectRaw();
?>

<div class="table-responsive">
    <table id="datatable-order_cart" class="dt-table display table" style="width: calc(100% - 2px)">
        <thead>
...
<span class="row-td" id="td-<?= $k ?>-tbl_order_cart-tbl_order_cart_id" hidden><?= $tbl_order_cart_id; ?></span>

<span class="row-td" id="td-<?= $k ?>-tbl_order_cart-tbl_order_id" hidden><?= $tbl_order_id; ?></span>

<span class="row-td" id="td-<?= $k ?>-tbl_order_cart-tbl_cart_id" hidden><?= $tbl_cart_id; ?></span>
                <tr>
                                                                                            <td class="text-center">
<?= $tbl_order_cart_id; ?></td>
                                                                                            <td class="text-center">
<?= $order_no; ?></td>
                                                                                            <td class="text-center">
<?= $quantity_cart; ?></td>
...
<button type="button" class="btn btn-outline-danger btn-action me-2" onclick="deleteInfo('tbl_order_cart','tbl_order_cart_id',<?=  $tbl_order_cart_id;  ?>)"><i class="bi bi-trash"></i></button>
</td>
                                    </tr>
