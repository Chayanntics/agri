    ...
    <div class="card-body">
        <div class="basic-form ps-3 pe-3 pb-3">
            ...
            <form method="post" action="functions/post.php" class="form-valide-with-icon needs-validation" novalidate id="frm-row" enctype="multipart/form-data">
                ...
                <input type='hidden' id='form-table' name='table[]' class='none' value='tbl_delivery'>

                <div id="form-div-delivery">
                    <div class="form-source">

                        <input type='hidden' id='delivery-tbl_delivery_id' name='tbl_delivery-tbl_delivery_id[]' class='editable none' value=''>
                        <div class='row'>

                                                                <div class='col-md-12 form-group '>
                                        <div class='row mb-2'>

                                            <label for='delivery-tbl_order_id' class="text-label form-label">order:</label>

                                            <div class=''>
                                                <select name='tbl_delivery-tbl_order_id[]' id='delivery-tbl_order_id' class='form-control editable ' required>
...
?>
                                        ...
                                        <div class='row mb-2'>
                                            ...
                                            <label for='delivery-tbl_address_id' class="text-label form-label">address:</label>

                                            <div class=''>
                                                <select name='tbl_delivery-tbl_address_id[]' id='delivery-tbl_address_id' class='form-control editable ' required>
                                                    <option value=''>-select-</option>
...
extract($r);
 ?>
                                                        ...
                                                        <option value='<?=  $tbl_address_id  ?>'><?=  $address  ?></option>
...
?>
                                        ...
                                        <div class='row mb-2'>
                                            ...
                                            <label for='delivery-tbl_driver_id' class="text-label form-label">driver:</label>

                                            <div class=''>
                                                <select name='tbl_delivery-tbl_driver_id[]' id='delivery-tbl_driver_id' class='form-control editable ' required>
                                                    <option value=''>-select-</option>
...
extract($r);
 ?>
                                                        ...
                                                        <option value='<?=  $tbl_driver_id  ?>'><?=  $driver_name  ?></option>
...
?>
                            ...
                            <div class="col-md-12 text-end">
                                <button type='button' class='btn btn-outline-info btn-sm' onclick="addNewForm('#form-div-delivery')">Add New (+)</button>
                            </div>
                        </div>
...
<?php
$sql = "SELECT * FROM tbl_delivery  LEFT JOIN tbl_order ON tbl_order.tbl_order_id=tbl_delivery.tbl_order_id LEFT JOIN tbl_address ON tbl_address.tbl_address_id=tbl_delivery.tbl_address_id LEFT JOIN tbl_driver ON tbl_driver.tbl_driver_id=tbl_delivery.tbl_driver_id";
$m->sql = $sql;
$record = $m->selectRaw();
?>

<div class="table-responsive">
    <table id="datatable-delivery" class="dt-table display table" style="width: calc(100% - 2px)">
        <thead>
...
<span class="row-td" id="td-<?= $k ?>-tbl_delivery-tbl_delivery_id" hidden><?= $tbl_delivery_id; ?></span>

<span class="row-td" id="td-<?= $k ?>-tbl_delivery-tbl_order_id" hidden><?= $tbl_order_id; ?></span>

<span class="row-td" id="td-<?= $k ?>-tbl_delivery-tbl_address_id" hidden><?= $tbl_address_id; ?></span>

<span class="row-td" id="td-<?= $k ?>-tbl_delivery-tbl_driver_id" hidden><?= $tbl_driver_id; ?></span>
                <tr>
                                                                                            <td class="text-center">
<?= $tbl_delivery_id; ?></td>
                                                                                            <td class="text-center">
...
<button type="button" class="btn btn-outline-danger btn-action me-2" onclick="deleteInfo('tbl_delivery','tbl_delivery_id',<?=  $tbl_delivery_id;  ?>)"><i class="bi bi-trash"></i></button>
</td>
                                    </tr>
