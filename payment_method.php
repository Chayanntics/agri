    ...
    <div class="card-body">
        <div class="basic-form ps-3 pe-3 pb-3">
            ...
            <form method="post" action="functions/post.php" class="form-valide-with-icon needs-validation" novalidate id="frm-row" enctype="multipart/form-data">
                ...
                <input type='hidden' id='form-table' name='table[]' class='none' value='tbl_payment_method'>

                <div id="form-div-payment_method">
                    <div class="form-source">

                        <input type='hidden' id='payment_method-tbl_payment_method_id' name='tbl_payment_method-tbl_payment_method_id[]' class='editable none' value=''>
                        <div class='row'>

                                                                <div class='col-md-12 form-group '>
                                        <div class='row mb-2'>

                                            <label for='payment_method-payment_method' class="text-label form-label">payment method:</label>

                                            <div class=''>
                                                <input type='text' name='tbl_payment_method-payment_method[]' id='payment_method-payment_method' class='form-control editable ' value='' required>
                            ...
                            <div class="col-md-12 text-end">
                                <button type='button' class='btn btn-outline-info btn-sm' onclick="addNewForm('#form-div-payment_method')">Add New (+)</button>
                            </div>
                        </div>
...
<div class="table-responsive">
    <table id="datatable-payment_method" class="dt-table display table" style="width: calc(100% - 2px)">
        <thead>
...
<span class="row-td" id="td-<?= $k ?>-tbl_payment_method-tbl_payment_method_id" hidden><?= $tbl_payment_method_id; ?></span>

<span class="row-td" id="td-<?= $k ?>-tbl_payment_method-payment_method" hidden><?= $payment_method; ?></span>
                <tr>
                                                                                            <td class="text-center">
<?= $tbl_payment_method_id; ?></td>
                                                                                            <td class="text-center">
<?= $payment_method; ?></td>
                                                                <td class="text-center ">
<button type="button" class="btn btn-outline-info btn-action me-2" onclick="editInfo(<?= $k ?>)"><i class="bi bi-pen"></i></button>
<button type="button" class="btn btn-outline-danger btn-action me-2" onclick="deleteInfo('tbl_payment_method','tbl_payment_method_id',<?=  $tbl_payment_method_id;  ?>)"><i class="bi bi-trash"></i></button>
</td>
                                    </tr>
