    ...
    <div class="card-body">
        <div class="basic-form ps-3 pe-3 pb-3">
            ...
            <form method="post" action="functions/post.php" class="form-valide-with-icon needs-validation" novalidate id="frm-row" enctype="multipart/form-data">
                ...
                <input type='hidden' id='form-table' name='table[]' class='none' value='tbl_order'>

                <div id="form-div-order">
                    <div class="form-source">

                        <input type='hidden' id='order-tbl_order_id' name='tbl_order-tbl_order_id[]' class='editable none' value=''>
                        <div class='row'>

                                                                <div class='col-md-12 form-group '>
                                        <div class='row mb-2'>

                                            <label for='order-order_no' class="text-label form-label">no:</label>

                                            <div class=''>
                                                <input type='text' name='tbl_order-order_no[]' id='order-order_no' class='form-control editable ' value='' required>
                                        ...
                                        <div class='row mb-2'>
                                            ...
                                            <label for='order-datetime_order' class="text-label form-label">datetime order:</label>

                                            <div class=''>
                                                <input type='datetime-local' name='tbl_order-datetime_order[]' id='order-datetime_order' class='form-control editable ' value='' required>
                                                                                                <div class="invalid-feedback">
                                                    Please Enter a datetime order.
                                                </div>
                                            </div>
                            ...
                            <div class="col-md-12 text-end">
                                <button type='button' class='btn btn-outline-info btn-sm' onclick="addNewForm('#form-div-order')">Add New (+)</button>
                            </div>
                        </div>
...
<div class="table-responsive">
    <table id="datatable-order" class="dt-table display table" style="width: calc(100% - 2px)">
        <thead>
            <tr class='text-center'>
                        ...
                        <label class='mb-0'>No</label>
                                    ...
                                    <td class='text-center'>
                        <label class='mb-0'>Datetime Order</label>
                    </td>
                                                    <td class=" text-center">
...
<span class="row-td" id="td-<?= $k ?>-tbl_order-tbl_order_id" hidden><?= $tbl_order_id; ?></span>

<span class="row-td" id="td-<?= $k ?>-tbl_order-order_no" hidden><?= $order_no; ?></span>

<span class="row-td" id="td-<?= $k ?>-tbl_order-datetime_order" hidden><?= $datetime_order; ?></span>
                <tr>
                                                                                            <td class="text-center">
<?= $tbl_order_id; ?></td>
                                                                                            <td class="text-center">
...
<button type="button" class="btn btn-outline-danger btn-action me-2" onclick="deleteInfo('tbl_order','tbl_order_id',<?=  $tbl_order_id;  ?>)"><i class="bi bi-trash"></i></button>
</td>
                                    </tr>
