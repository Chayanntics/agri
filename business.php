    ...
    <div class="card-body">
        <div class="basic-form ps-3 pe-3 pb-3">
            ...
            <form method="post" action="functions/post.php" class="form-valide-with-icon needs-validation" novalidate id="frm-row" enctype="multipart/form-data">
                ...
                <input type='hidden' id='form-table' name='table[]' class='none' value='tbl_business'>

                <div id="form-div-business">
                    <div class="form-source">

                        <input type='hidden' id='business-tbl_business_id' name='tbl_business-tbl_business_id[]' class='editable none' value=''>
                        <div class='row'>

                                                                <div class='col-md-12 form-group '>
                                        <div class='row mb-2'>

                                            <label for='business-business_name' class="text-label form-label">name:</label>

                                            <div class=''>
                                                <input type='text' name='tbl_business-business_name[]' id='business-business_name' class='form-control editable ' value='' required>
                            ...
                            <div class="col-md-12 text-end">
                                <button type='button' class='btn btn-outline-info btn-sm' onclick="addNewForm('#form-div-business')">Add New (+)</button>
                            </div>
                        </div>
...
<div class="table-responsive">
    <table id="datatable-business" class="dt-table display table" style="width: calc(100% - 2px)">
        <thead>
...
<span class="row-td" id="td-<?= $k ?>-tbl_business-tbl_business_id" hidden><?= $tbl_business_id; ?></span>

<span class="row-td" id="td-<?= $k ?>-tbl_business-business_name" hidden><?= $business_name; ?></span>
                <tr>
                                                                                            <td class="text-center">
<?= $tbl_business_id; ?></td>
                                                                                            <td class="text-center">
...
<button type="button" class="btn btn-outline-danger btn-action me-2" onclick="deleteInfo('tbl_business','tbl_business_id',<?=  $tbl_business_id;  ?>)"><i class="bi bi-trash"></i></button>
</td>
                                    </tr>
