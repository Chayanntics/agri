                ...
                <div class="">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div>
                                <h4 class="card-title">driver Form</h4>
                        ...
                        <div class="card-body">
                            <div class="basic-form ps-3 pe-3 pb-3">
                                ...
                                <form method="post" action="functions/post.php" class="form-valide-with-icon needs-validation" novalidate id="frm-row" enctype="multipart/form-data">
                                    ...
                                    <input type='hidden' id='form-table' name='table[]' class='none' value='tbl_driver'>

                                    <div id="form-div-driver">
                                        <div class="form-source">

                                            <input type='hidden' id='driver-tbl_driver_id' name='tbl_driver-tbl_driver_id[]' class='editable none' value=''>
                                            <div class='row'>

                                                <div class='col-md-12 form-group '>
                                                    <div class='row mb-2'>

                                                        <label for='driver-driver_name' class="text-label form-label">name:</label>

                                                        <div class=''>
                                                            <input type='text' name='tbl_driver-driver_name[]' id='driver-driver_name' class='form-control editable ' value='' required>
                                                ...
                                                <div class='col-md-12 form-group '>
                                                    <div class='row mb-2'>
                                                        ...
                                                        <label for='driver-vehicle' class="text-label form-label">vehicle:</label>

                                                        <div class=''>
                                                            <input type='text' name='tbl_driver-vehicle[]' id='driver-vehicle' class='form-control editable ' value='' required>
                                                            <div class="invalid-feedback">
                                                ...
                                                <div class='col-md-12 form-group '>
                                                    <div class='row mb-2'>
                                                        ...
                                                        <label for='driver-tbl_account_id' class="text-label form-label">account:</label>

                                                        <div class=''>
                                                            <select name='tbl_driver-tbl_account_id[]' id='driver-tbl_account_id' class='form-control editable ' required>
                                                                ...
                                                                ?>
                                                                    ...
                                                                    <option value='<?= $tbl_account_id  ?>'><?= $username  ?></option>
                                    ...
                                    <div class="row multi-form" hidden>
                                        <div class="col-md-12 text-end">
                                            <button type='button' class='btn btn-outline-info btn-sm' onclick="addNewForm('#form-div-driver')">Add New (+)</button>
                                        </div>
                                    </div>
                    ...
                    <div class="card dz-card">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade show active p-4">
                                ...
                                <?php
                                $sql = "SELECT * FROM tbl_driver  LEFT JOIN tbl_account ON tbl_account.tbl_account_id=tbl_driver.tbl_account_id";
                                $m->sql = $sql;
                                $record = $m->selectRaw();
                                ?>

                                <div class="table-responsive">
                                    <table id="datatable-driver" class="dt-table display table" style="width: calc(100% - 2px)">
                                        <thead>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                ...
                                                <span class="row-td" id="td-<?= $k ?>-tbl_driver-tbl_driver_id" hidden><?= $tbl_driver_id; ?></span>

                                                <span class="row-td" id="td-<?= $k ?>-tbl_driver-driver_name" hidden><?= $driver_name; ?></span>

                                                <span class="row-td" id="td-<?= $k ?>-tbl_driver-vehicle" hidden><?= $vehicle; ?></span>

                                                <span class="row-td" id="td-<?= $k ?>-tbl_driver-tbl_account_id" hidden><?= $tbl_account_id; ?></span>
                                                <tr>
                                                    <td class="text-center">
                                                        <?= $tbl_driver_id; ?></td>
                                                    <td class="text-center">
                                                    ...
                                                    <td class="text-center ">
                                                        ...
                                                        <button type="button" class="btn btn-outline-danger btn-action me-2" onclick="deleteInfo('tbl_driver','tbl_driver_id',<?= $tbl_driver_id;  ?>)"><i class="bi bi-trash"></i></button>
                                                    </td>
                                                </tr>
